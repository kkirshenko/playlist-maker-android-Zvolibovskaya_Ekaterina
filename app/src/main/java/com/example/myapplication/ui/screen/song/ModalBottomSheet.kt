package com.example.myapplication.ui.screen.song
...
import com.example.myapplication.ui.screen.playlists.PlaylistListItem
                    ...
                    LazyColumn(modifier = Modifier.fillMaxSize()) {
                       items(playlists) { playlist ->
                            PlaylistListItem(playlist = playlist) {
                                viewModel.insertSongToPlaylist(track!!, playlist.id)
